...
app.get('/', (req, res) => {
  res.render('home.ejs', { restr: RESTAURANT })
})
app.get('/menu', (req, res) => {
  res.render('menu.ejs', { restr: RESTAURANT })
})
app.get('/menu/:category', (req, res) => {
  let filteredCa = []
  RESTAURANT.menu.forEach((elem) => {
    if (req.params.category === elem.category) {
      filteredCa.push(elem)
    }
  })
  res.render('category.ejs', {
    filteredCa: filteredCa,
